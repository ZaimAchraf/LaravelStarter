                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                ...
                                <a class="ml-3" href="{{route('providers.create')}}">
                                ...
                                <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        <p class="text-muted font-13 m-b-30">
                                            Pour Ajouter un Fournisseurs merci de cliquer sur l'icone : <i class="fa fa-plus-circle"></i> a droite du titre : "Liste des Fournisseurss" au-dessus.
                                        </p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span style="word-wrap: break-word;">
                                                            @if($provider->user)
                                                                <b class="text-success">{{$provider->user->username}}</b>
                                                            @else
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex p-0 m-0">
                                                            <a href="{{ route('providers.edit', $provider) }}" class="text-white font-bold px-2 rounded mr-2" style="background: #2fff67;
                                                                    line-height: 1;
                                                            ...
                                                            <form class="d-inline m-0" action="{{ route('providers.destroy', $provider->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr?');">
...
{{--                                                            <form class="d-inline m-0" action="{{ route('providers.enable_disable', $provider->id) }}" method="POST">--}}
{{--                                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">--}}
{{--                                                                <button type="submit" class="text-white font-bold py-1 px-2 rounded mr-2"--}}
{{--                                                                        style="background: {{$provider->is_active ? '#ff2f47' : '#2fff67'}} ;--}}
{{--                                                                    border: none;--}}
{{--                                                                    margin: 0;--}}
{{--                                                                    line-height: 1;--}}
{{--                                                                    padding: .4em .8em !important;">--}}
