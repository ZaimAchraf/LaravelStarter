                            ...
                            <form method="post" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" value="{{ $product->label }}" data-validate-length-range="6" data-validate-words="2" name="label"  placeholder="Label..."  />
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Référence</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" value="{{ $product->ref }}" data-validate-length-range="6" data-validate-words="2" name="ref"  placeholder="Reference..."  />
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Qte</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="number" class="form-control" value="{{$product->Qte}}" data-validate-length-range="6" data-validate-words="2" name="Qte"  placeholder="Qte..."  />
                                    </div>
                                </div>
