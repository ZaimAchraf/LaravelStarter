        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_content">
                            <form method="post" action="{{ route('credits.update', $credit->id) }}" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
{{--                                <span class="section">User Info</span>--}}
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="number" data-validate-length-range="6" data-validate-words="2" name="paid" value="{{ $credit->paid }}" required="required" />
                                    </div>
                                </div>
                                <div class="field item form-group">
