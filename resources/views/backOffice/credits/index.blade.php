                                ...
                                <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        <p class="text-muted font-13 m-b-30">
                                            Pour Ajouter un crédit merci de le faire depuis la page des <a href="{{route('quotations.index')}}">devis</a>.
                                            <br>
                                        </p>
                                        ...
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            @foreach ($credits as $credit)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <b style="color: #ff5959">{{ $credit->total - $credit->paid }} DH</b>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex p-0 m-0">
{{--                                                            <a href="{{ route('credits.edit', $credit) }}" class="text-white font-bold px-2 rounded mr-2" style="background: #2fff67;--}}
{{--                                                                    line-height: 1;--}}
...
{{--                                                            </a>--}}
                                                            <a href="{{ route('credits.payments', $credit) }}" class="text-white font-bold px-2 rounded mr-2" style="background: #009893;
                                                                    line-height: 1;
                                                                    padding: .4em .8em !important;
                                                                    display: flex;
                                                                    align-items: center">
