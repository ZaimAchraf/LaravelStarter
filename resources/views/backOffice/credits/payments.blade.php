                                ...
                                <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        <p class="text-muted font-13 m-b-30">
                                            Pour creer un paiement merci de le faire dans la pages des <a href="{{route('credits.index')}}">credits</a> en cliquant sur <i class="fa fa-pencil"></i> dans la ligne liée au credit payé.
                                            <br>
                                        </p>
                                        ...
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                            @foreach ($credit->lines as $payment)
                                                <tr>
                                                    <td>
                                                        {{$payment->id}}
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="/uploads/credits/{{ $payment->document }}" target="_blank">{{ $payment->document }}</a>
                                                    </td>
                                                    <td>
                                                        {{ $payment->comment }}
                                                    </td>
