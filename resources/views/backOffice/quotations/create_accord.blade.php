        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_content">
                            <form method="post" action="{{ route('quotations.accord.create', $quotation->id) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="field item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Document Accord</label>
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="ligneDevis {{$i != 0 ? 'ligneDevis-new' : ''}}">
                                            ...
                                            <div class="provider-infos" >
                                                ...
                                                <div class="field item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <input class="form-control" disabled type="text" name="lines[{{$i}}][provider]" value="{{ $ql->provider->name }}" class="flat"/>
                                                    </div>
                                                </div>
                                                <div class="field item form-group">
                                                    <label class="col-form-label col-md-3 col-sm-3  label-align">Prix d'Achat </label>
                                                    <div class="col-md-6 col-sm-6">
                                                        <input class="form-control" disabled value="{{ $ql->purchase_price }}" data-validate-length-range="6" data-validate-words="2" name="lines[{{$i}}][purchase_price]"  />
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
            ...
            nouvelleLigne.innerHTML = `
                ...
                <div class="provider-infos" style="display: none;">
                    <div class="field item form-group">
                        <label class="col-form-label col-md-3 col-sm-3  label-align">Fournisseur</label>
                        <div class="col-md-6 col-sm-6">
                            <select name="lines[${linesNumber}][exist_provider]" id="exist_provider" class="form-control exist_provider">
