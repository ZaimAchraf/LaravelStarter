...
@section("title","Liste des Factures Aggrégées")
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Gestion des Factures Aggrégée</h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                Liste des Factures Aggrégée
                                <a class="ml-3" href="{{route('aggregatedInvoices.create')}}">
                                ...
                                <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        <p class="text-muted font-13 m-b-30">
                                            Pour ajouter une facture aggrégée merci de cliquer sur l'icone : <i class="fa fa-plus-circle"></i> a droite du titre : "Liste des Factures Aggrégée"
                                            <br>
                                        </p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex p-0 m-0">
                                                            ...
                                                            <form class="d-inline m-0" action="{{ route('aggregatedInvoices.destroy', $invoice->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr?');">
