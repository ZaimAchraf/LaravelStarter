        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_content">
                            <form method="post" action="{{ route('aggregatedInvoices.update')}}" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
...
{{--                                <span class="section">User Info</span>--}}
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" value="{{ $invoice->client }}" data-validate-length-range="6" data-validate-words="2" name="client" />
                                    </div>
                                </div>
                                ...
                                <div class="ln_solid mt-1">
                                    <div class="form-group">
                                        <div class="col-md-6 offset-md-3  pt-2">1`````````
                                            ...
                                            <a href="{{route('aggregatedInvoices.index')}}" class="btn btn-secondary">Annuler</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
    ...
    <script>
        ...
        function deleteLineBackend(event, index) {
            ...
            if (confirmation) {
                $.ajax({
                    type: 'post',
                    url: '/aggregated-invoices/deleteLine',
                    data: {
                        _token: csrfToken,
                        line_id: lineId
                    },
