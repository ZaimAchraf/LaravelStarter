        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_content">
                            <form method="post" action="{{ route('aggregatedInvoices.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="client-infos">
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Client</label>
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" value="" data-validate-length-range="6" data-validate-words="2" name="client"  placeholder="ex. John f. Kennedy"  />
                                        </div>
                                    </div>
                                </div>
