                                ...
                                <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        <p class="text-muted font-13 m-b-30">
                                            Pour Ajouter un BL merci de le faire depuis la page des <a href="{{route('orders.index')}}">commandes</a>.
                                            <br>
                                        </p>
                                        ...
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            @foreach ($deliveryNotes as $deliveryNote)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $deliveryNote->order->provider->name }}
                                                    </td>
                                                    <td>
                                                        <a href="uploads/delivery_notes/{{ $deliveryNote->document }}" target="_blank">{{ $deliveryNote->document }}</a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex p-0 m-0">
                                                            ...
                                                            <form class="d-inline m-0" action="{{ route('deliveryNotes.destroy') }}" method="POST" onsubmit="return confirm('Êtes-vous sûr?');">
                                                            ...
                                                            <a href="{{ route('deliveryNotes.show', $deliveryNote) }}" class="text-white font-bold px-2 rounded mr-2" style="background: #009893;
                                                                    line-height: 1;
                                                                    padding: .4em .8em !important;
                                                                    display: flex;
                                                                    align-items: center">
