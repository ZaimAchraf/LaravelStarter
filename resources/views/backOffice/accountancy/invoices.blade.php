            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                Liste des Facture de vente
                                <a class="ml-3" href="{{route('accountants.createInvoice')}}">
                                ...
                                <div class="col-sm-12">
                                    <div class="card-box table-responsive">
                                        <p class="text-muted font-13 m-b-30">
                                            Pour Ajouter une facture merci de cliquer sur l'icone : <i class="fa fa-plus-circle"></i> a droite du titre : "Liste des Facture de vente" au-dessus.
                                            <br>
                                        </p>
                                        ...
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                            ...
                                            @foreach ($invoices as $invoice)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/uploads/achats/facture/{{ $invoice->document }}" target="_blank">{{ $invoice->document }}</a>
                                                    </td>
                                                    <td>
...
{{--                                                            <a href="{{ route('invoices.show', $invoice) }}" class="text-white font-bold px-2 rounded mr-2" style="background: #007070;--}}
{{--                                                                    line-height: 1;--}}
...
{{--                                                            </a>--}}
                                                            ...
                                                            <form class="d-inline m-0" action="{{ route('accountants.destroyInvoice', $invoice) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr?');">
